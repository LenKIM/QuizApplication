...
public class MainActivity extends AppCompatActivity {
    ...
    private static final java.lang.String KEY_ANSWER = "answer";
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(KEY_ANSWER, mIsCheater);
    }

    private void noAnyQuestion() {
        Toast.makeText(MainActivity.this, R.string.no_more_question, Toast.LENGTH_SHORT).show();
    }
